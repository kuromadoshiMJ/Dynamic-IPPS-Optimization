...
class NSGAII:
    def __init__(self, num_jobs, num_machines, len_plan_max, num_operations_arr, num_process_plan_arr, len_process_plan_arr, process_plan_matrix, process_time_matrix, energy_matrix, alt_machines_dict, population_size, generations, mutation_rate_1, mutation_rate_2, crossover_rate, ):
    ...
    def random_individual(self):
        chromosome = Chromosome(self.num_jobs, self.len_plan_max, self.num_operations_arr)
...
if __name__ == "__main__" :
    ...
    nsga2 = NSGAII(num_jobs, num_machines, len_plan_max, num_operations_arr, num_process_plan_arr, len_process_plan_arr, process_plan_matrix, process_time_matrix, energy_matrix, alt_machines_dict, population_size = 50, generations = 20, mutation_rate_1=0.3, mutation_rate_2=0.3, crossover_rate=0.8)
